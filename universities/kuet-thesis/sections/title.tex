...
\begin{center}
    ...
    \vspace{0.3cm}
    {\large \bfseries \color{secondary} Bachelor of Science in Electrical and Electronic Engineering}
    
    \vspace{1.5cm}
    
    {Department of Computer Science and Engineering} \\
    \vspace{0.2cm}
    {\large \bfseries \color{primary} Khulna University of Engineering and Technology} \\
    \vspace{0.1cm}
    {Khulna, Bangladesh}
