...
\begin{center}
    ...
    \begin{tikzpicture}[scale=2]
        \draw[fill=primary, draw=none] (-0.5,-0.5) -- (0,0.5) -- (0.5,-0.5) -- cycle; \draw[fill=white, draw=none] (-0.2,-0.3) -- (0,0.2) -- (0.2,-0.3) -- cycle; \node[primary, font=\tiny\bfseries] at (0,-0.65) {CAMBRIDGE};
    \end{tikzpicture}
    ...
    \vspace{0.2cm}
    {\large \bfseries \color{primary} University of Cambridge} \\
    \vspace{0.1cm}
