...
\maketitle
\thispagestyle{empty}\begin{center}{\footnotesize\itshape Unofficial template, not affiliated with or endorsed by the university. Sample content only.\par}\end{center}
