...
\begin{center}
    ...
    \begin{tikzpicture}[scale=2]
        \draw[fill=primary, draw=none] (-0.5,-0.5) rectangle (0.5,0.5); \draw[fill=white, draw=none] (-0.4,-0.4) rectangle (0.4,0.4); \node[primary, font=\tiny\bfseries] at (0,0) {IISc};
    \end{tikzpicture}
    ...
    \vspace{0.2cm}
    {\large \bfseries \color{primary} Indian Institute of Science} \\
    \vspace{0.1cm}
    {Bengaluru, India}
