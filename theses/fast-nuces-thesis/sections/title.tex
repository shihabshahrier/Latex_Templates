...
\begin{center}
    ...
    \vspace{0.3cm}
    {\large \bfseries \color{secondary} Bachelor of Science in Computer Science}
    
    \vspace{1.5cm}
    
    {\large Department of Computer Science and Engineering} \\
    \vspace{0.2cm}
    {\large \bfseries \color{primary} National University of Computer and Emerging Sciences} \\
    \vspace{0.1cm}
    {Islamabad, Pakistan}
