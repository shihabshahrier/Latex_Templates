...
\begin{center}
    ...
    \begin{tikzpicture}[scale=2]
        \draw[fill=primary, draw=none] (-0.5,-0.5) rectangle (0.5,0.5); \draw[fill=secondary, draw=none] (-0.3,-0.3) rectangle (0.3,0.3); \node[white, font=\tiny\bfseries] at (0,0) {NUS};
    \end{tikzpicture}
    ...
    \vspace{0.2cm}
    {\large \bfseries \color{primary} National University of Singapore} \\
    \vspace{0.1cm}
    {Singapore}
